...
All newly added or enabled audio is commercially usable CC0/public-domain material.

## Sound effects

- **60 CC0 Sci-Fi SFX** by rubberduck, CC0: https://opengameart.org/content/60-cc0-sci-fi-sfx
- The supplied OGGs were converted to WAV for reliable WPF playback. Curated clips are used for player/enemy fire, hazard warnings, black holes, novas, power-ups, extra ships, cash celebrations, comets, and boss alerts.
- **Fire Crackling** by Eric Skiff, CC0 — comet arrival crackle: https://opengameart.org/content/fire-crackling
- **Space Ship Shield Sounds** by bart, CC0 — shield activation: https://opengameart.org/content/space-ship-shield-sounds
...
- **Persevere** by Vitalezzz, CC0 — Wave 1 background: https://opengameart.org/content/persevere
- **Virtual Rush**, **Subspace**, and **The Rift** by Vitalezzz, CC0 — later wave backgrounds: https://opengameart.org/content/virtual-rush, https://opengameart.org/content/subspace, and https://opengameart.org/content/the-rift
