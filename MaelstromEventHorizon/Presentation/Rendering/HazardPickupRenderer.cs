...
internal sealed class HazardPickupRenderer
{
    ...
    internal void DrawVortexCore(DrawingContext dc)
    {
        ...
        dc.DrawEllipse(Brushes.Black, new Pen(new SolidColorBrush(Color.FromRgb(206, 164, 255)), 1), new Point(), 13,
            13);
        ...
        foreach (Pickup pickup in view.Game.Pickups)
        {
            ...
            if (pickup.Kind == PickupKind.Canister)
            {
                ...
                else
                {
                    ...
                    dc.DrawRoundedRectangle(shell, new Pen(new SolidColorBrush(color), 1.5), new Rect(-11, -16, 22, 32),
                        5, 5);
            ...
            else if (pickup.Kind == PickupKind.TimeFreeze)
            {
                ...
                dc.DrawEllipse(new RadialGradientBrush(Colors.White, view.Darken(color, .72)), rim, new Point(), 17,
                    17);
                dc.DrawEllipse(new SolidColorBrush(Color.FromArgb(150, 6, 30, 58)), new Pen(Brushes.White, 1),
                    new Point(), 12, 12);
                for (int i = 0; i < 8; i++)
                {
                ...
                Geometry hourglass = view.Polygon((-7, -8), (7, -8), (3.5, -2), (3.5, 2), (7, 8), (-7, 8), (-3.5, 2),
                    (-3.5, -2));
