...
internal static class DrawingContextArcExtensions
{
    public static void DrawArc(
        this DrawingContext dc, Pen pen, Point center, double radius, double startDegrees, double sweepDegrees)
    {
        ...
        using (StreamGeometryContext context = geometry.Open())
        {
            ...
            context.ArcTo(
                p1, new Size(radius, radius), 0, Math.Abs(sweepDegrees) > 180,
